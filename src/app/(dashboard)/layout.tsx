...
const adminNav: NavItem[] = [
  ...
  { label: "Behaviour Chart", href: "/admin/behaviour", icon: "Star" },
...
const parentNav: NavItem[] = [
  ...
  { label: "Assignments", href: "/parent/assignments", icon: "ClipboardCheck" },
  { label: "Lesson Notes", href: "/parent/lesson-notes", icon: "BookOpen" },
  { label: "Scheme of Work", href: "/parent/scheme-of-work", icon: "BookOpen" },
...
const studentNav: NavItem[] = [
  ...
  { label: "Scheme of Work", href: "/student/scheme-of-work", icon: "BookOpen" },
  { label: "Weekly Reports", href: "/student/weekly-reports", icon: "ClipboardList" },
