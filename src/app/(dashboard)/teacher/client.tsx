...
export default function TeacherDashboardClient({ data }: { data: TeacherDashboardData }) {
  const { stats, lessons, assignments, schedule, events, attendanceMarked } = data
  ...
  return (
    <div className="floating-orbs p-4 md:p-6 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-4">
        {[
          { label: "Classes", value: stats.classes, icon: BookOpen, gradient: "from-blue-600 to-blue-500" },
          { label: "Students", value: stats.students, icon: Users, gradient: "from-emerald-600 to-emerald-500" },
          { label: "Lesson Notes", value: stats.lessons, icon: FileText, gradient: "from-violet-600 to-violet-500" },
          { label: "Assignments", value: stats.assignments, icon: ClipboardCheck, gradient: "from-amber-600 to-amber-500" },
        ].map((stat, i) => {
