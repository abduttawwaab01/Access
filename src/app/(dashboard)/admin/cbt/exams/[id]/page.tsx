      ...
      {questions.length === 0 ? (
        ...
        <div className="space-y-2">
          {questions.map((q, i) => {
            ...
            const Icon = typeIcons[displayQ.type] || HelpCircle
            return (
                      ...
                      <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex items-center gap-2 mt-0.5">
                            <Badge variant="outline" className="text-[10px] px-1.5 py-0">{(displayQ.type || "mcq") === "true_false" ? "T/F" : (displayQ.type || "mcq").toUpperCase()}</Badge>
