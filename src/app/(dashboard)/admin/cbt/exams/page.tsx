...
export default function ExamsPage() {
  ...
  const openCreate = () => {
    setEditing(null)
    setForm({ title: "", description: "", duration: 30, shuffleQuestions: false, showResults: true, subjectIds: [], classId: "", type: "regular", requireFullscreen: true, tabSwitchLimit: 3, allowCopyPaste: false, maxAttempts: 0 })
    setSheetOpen(true)
  }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const body = { ...form, subjectId: form.subjectIds[0], subjectIds: form.subjectIds }
  ...
  const filteredSubjects = form.classId ? subjects.filter((s) => s.classId === form.classId) : subjects
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <ConfirmDialog open={!!confirmDelete} onOpenChange={(o) => !o && setConfirmDelete(null)} onConfirm={confirmDeleteItem}
        title="Delete Exam" description={`Permanently delete ${confirmDelete?.title}? This cannot be undone.`} />
