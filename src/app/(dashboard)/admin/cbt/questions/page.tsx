...
export default function QuestionsPage() {
  ...
  return (
    <div className="p-4 md:p-6">
      ...
      <DeleteConfirm open={deleteOpen} onOpenChange={setDeleteOpen} onConfirm={handleDelete} title="Delete Question" description="This will remove the question from the bank." />
    </div>
  )
}
